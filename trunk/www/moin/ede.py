# -*- coding: iso-8859-1 -*-
"""
    MoinMoin - ede theme, based on modernized theme

    @copyright: 2003-2009 Nir Soffer, Thomas Waldmann, Sanel Zukan
    @license: GNU GPL, see COPYING for details.

    TODO: interwiki is not used and member should be removed
"""
