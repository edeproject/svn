...
class Config(DefaultConfig):
    ...
    logo_string = u'<img src="/moin-data/moin_static184/ede/img/ede.png" alt="EDE">'

    # Append EDE favicon
    html_head=u'<link rel="icon" href="/moin-data/moin_static184/ede/img/favicon.ico">'
    ...
    # backup it.
    data_underlay_dir = '/home/equinox/public_html/moin-data/underlay/'
    ...
    actions_excluded = ['RenderAsDocbook',]
